...
const goalsData = [
  ...
  },
  {
    ...
    progress: 70,
    updates: [
      { date: "2023-08-10", content: "Completed analysis of current routes" },
      { date: "2023-10-15", content: "Implemented new routing algorithms" },
      { date: "2023-12-05", content: "Initial tests show 7% reduction in fuel usage" },
    ],
    company: "flights",
  },
  {
    ...
    progress: 55,
    updates: [
      { date: "2023-09-20", content: "Completed guest journey mapping" },
      { date: "2023-11-10", content: "Launched mobile check-in at pilot locations" },
      { date: "2024-01-05", content: "Guest satisfaction scores up by 12% at pilot locations" },
    ],
    company: "hotels",
  },
  {
    ...
    progress: 100,
    updates: [
      { date: "2023-05-15", content: "Finalized contracts for new aircraft" },
      { date: "2023-08-22", content: "First batch of new aircraft delivered" },
      { date: "2023-10-30", content: "Completed crew training on new aircraft" },
      { date: "2023-11-28", content: "Goal completed with 32% of fleet modernized" },
    ],
    company: "flights",
  },
]
...
export default function GoalDetailPage() {
  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      <Button variant="ghost" className="mb-6 hover:bg-gray-100" onClick={() => router.push("/dashboard/goals")}>
